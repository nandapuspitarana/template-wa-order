...
class WaOrder_Customize {
    ...
    public static function register ( $wp_customize ) {
        ...
        $wp_customize->add_setting(
            'waorder_atc_bg_color',
            array(
                'default'    => '#FA591D', //Default setting/value to save
                'type'       => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
                'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
                'transport'  => 'refresh', //What triggers a refresh of the setting? 'refresh' or 'postMessage' (instant)?
            )
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                $wp_customize,
                'waorder_atc_bg_color_input',
                array(
                    'label'      => __( 'ATC Background Color', 'waorder' ), //Admin-visible name of the control
                    'settings'   => 'waorder_atc_bg_color', //Which setting to load and manipulate (serialized is okay)
                    'priority'   => 10, //Determines the order this control appears in for the specified section
                    'section'    => 'waorder_color_section', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
                )
            )
    ...
    public static function header_output() {
        $body_bg = get_theme_mod('body_bg','#fafafa');
        $color = get_theme_mod('waorder_color_scheme', '#61DDBB');
        $header_bg = get_theme_mod('header_bg', '#ffffff');
        $header_color = get_theme_mod('header_color_scheme', $color);
        $atc_bg_color = get_theme_mod('atc_button_bg', '#FA591D');
        $buy_bg_color = get_theme_mod('buy_button_bg', $color);

        $social_bg = get_theme_mod('social_bg', '#ffffff');
        $social_color = get_theme_mod('social_color', '#000000');

        $widget_bg = get_theme_mod('widgett_bg', '#ffffff');
        $widget_color = get_theme_mod('widgett_color', '#000000');

        $copyright_bg = get_theme_mod('copyright_background', $color);
        $copyright_color = get_theme_mod('copyright_text_color', '#ffffff');
        ?>
        <style type="text/css">
            a{color: <?php echo $color; ?>}
            a:hover{color:<?php echo $color; ?>}
            body{background:<?php echo $body_bg; ?>}
            ...
            .header-color-scheme-text{color: <?php echo $header_color; ?>;}
            .header-color-scheme-background{background: <?php echo $header_color; ?>;}
            .header-color-scheme-border{border-color: <?php echo $header_color; ?>;}
            .header-color-scheme-background-hover{background: #ffffff;color: rgba(0,0,0,.6);}
            .header-color-scheme-background-hover:hover{background: <?php echo $header_color; ?>;color: #ffffff;}
            .header .searchbox form input{color: <?php echo $header_color; ?>;}
            .tns-nav button.tns-nav-active{background: <?php echo $color; ?>;}
            .orderBox .variable .add-to-cart-button.add-to-cart-background{
            	background: <?php echo $atc_bg_color; ?> radial-gradient(circle,transparent 1%,<?php echo $atc_bg_color; ?> 1%) center/15000%;
            }
            .orderBox .variable .order-button{background: <?php echo $buy_bg_color;?>;}

            .socialbox{background: <?php echo $social_bg; ?>;color: <?php echo $social_color; ?>}
            .socialbox .social span{color: <?php echo $social_color; ?>}
            .socialbox .socials a.social{color: <?php echo $social_bg; ?>;background: <?php echo $social_color; ?>}

            .widgetbox{background: <?php echo $widget_bg; ?>; color: <?php echo $widget_color; ?>}
            .widgetbox .widget h3{color: <?php echo $widget_color; ?>}

            footer.footer{background: <?php echo $copyright_bg; ?>}
            footer.footer .copyright{color: <?php echo $copyright_color; ?>}
