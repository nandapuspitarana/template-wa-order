...
if ( ! class_exists( 'Customizer_Library' ) ) :
	...
	require plugin_dir_path( __FILE__ ) . 'custom-controls/range.php';

	require plugin_dir_path( __FILE__ ) . 'custom-controls/shortable.php';

	require plugin_dir_path( __FILE__ ) . 'custom-controls/icon-picker.php';

	require plugin_dir_path( __FILE__ ) . 'custom-controls/toggle.php';
