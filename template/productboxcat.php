<div class="productboxcat card-body tw-p-3 tw-box-border">
    <div class="card-inner tw-bg-white tw-rounded-xl tw-border tw-border-brand/40 tw-shadow-sm tw-overflow-hidden">
        ...
        <div class="card-body-text tw-p-3 tw-flex tw-flex-col tw-gap-2">
            ...
            <div class="card-rating tw-flex tw-items-center tw-gap-2">
                ...
                <span class="rating-text tw-text-xs tw-text-slate-500">5 (469)</span>
            </div>
            <?php
            ...
            <form class="card-footer-line tw-flex tw-flex-col tw-gap-3 tw-pt-1">
                ...
                <div class="pricing tw-flex tw-items-baseline tw-gap-2">
                    <span class="price tw-font-semibold tw-text-slate-900">Rp <?php echo number_format($price,0,',','.'); ?></span>
                ...
                <div class="card-add-wrap tw-w-full">
                    <button type="button" x-on:click="addToCartWA($event.currentTarget)" class="btn btn-primary btn-sm card-add-btn tw-w-full tw-justify-center tw-inline-flex tw-items-center tw-gap-1 tw-bg-brand tw-text-white tw-rounded-md tw-px-3 tw-py-1.5 tw-text-xs tw-font-semibold">
