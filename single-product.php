						...
						<div class="contentbox">
							...
							<form class="orderBox" method="post" enctype="multipart/form-data" id="productData">
								...
								<div class="variable clear">
									<button type="button" class="order-button<?php if( $is_out_stock == 'yes' ){ echo ' outofstock';}else{echo '" onclick="singleCartWA(this);';} ?>">
										<i class="lni lni-whatsapp"></i>
										Pesan Sekarang
									</button>
									<?php if( get_theme_mod('atc_button_enable', 1) ){ ?>
